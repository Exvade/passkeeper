...
<body class="bg-slate-900 h-screen flex items-center justify-center text-white">

    <div class="bg-slate-800 p-8 rounded-2xl shadow-2xl w-full max-w-md border border-slate-700">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-indigo-400 tracking-tight">PassKeeper</h1>
            <p class="text-slate-400 mt-2 text-sm">Kelola password tanpa pusing, aman & terenkripsi.</p>
        </div>

        <a href="{{ route('google.redirect') }}"
            class="flex items-center justify-center gap-3 w-full bg-white text-slate-900 font-semibold py-3 px-4 rounded-xl hover:bg-gray-100 transition-all active:scale-95">
            {{-- Icon Google SVG --}}
